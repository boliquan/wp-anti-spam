...
Tags: wp anti spam,spambot,hidden field,spam,spammer,anti spam,comment,ip,author,email,url,robot,automated spambots,blacklist,block spam,bot,comment spam,session,some chinese,chinese,artificial,word limit
License: GPLv2
...
9. Check "Delete Options" to delete options while deactivate this plugin.
10. Check "Support Author" to help more people known of WP Anti Spam,in order to help them stay away from spam comments.
